        ...
        <div>
            ...
            <div className='flex flex-col laptop:flex-row mt-10 mb-4 items-start justify-between w-[90%] laptop:w-[80%] mx-auto'>
                <div className=' laptop:w-[50%]'>
                    <div className='bg-[#d0c5ad] mini:w-[90%] tablet:w-[80%] mini:text-[20px] mob:text-[35px] tablet:text-[45px] mx-auto laptop:ml-0 mb-10 text-center  ' style={{ fontFamily: "'Frunchy', sans-serif" }}>Inclusión y Empoderamiento</div>
                ...
                <div className='laptop:w-[50%] mini:order-[-1] laptop:order-1 flex tablet:justify-end my-6 laptop:my-0 mx-auto'>
                    <img className='mini:h-[25vh] tablet:h-[65vh]' src={inclusion} alt="inclusion" />
                </div>
            </div>
